...
public class WaypointEditor
{
    ...
    {
        if (waypoint == null) return; // Evita erros de referência nula
        ...
        if (waypoint.nextWaypoint != null)
        {
            ...
            Vector3 offset = waypoint.transform.right * -waypoint.waypointWidth / 2f;
            Vector3 offsetTo = waypoint.nextWaypoint.transform.right * -waypoint.nextWaypoint.waypointWidth / 2f; // Corrigido!
